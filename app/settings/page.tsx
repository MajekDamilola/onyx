  ...
  return (
    <button
      ...
      className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full transition-colors duration-200 ${
        enabled ? "bg-[#BCEDE2]" : "bg-[#252929]"
      }`}
    >
      <span
        className={`pointer-events-none mt-0.5 ml-0.5 inline-block h-4 w-4 rounded-full bg-[#090A0A] shadow-sm transition-transform duration-200 ${
...
function SectionCard({ children }: { children: React.ReactNode }) {
  return (
    <div className="rounded-[12px] border border-[#252929] bg-[#0E1010] overflow-hidden">
      {children}
    </div>
  );
}
...
function SectionHeader({ icon: Icon, title, description }: { icon: typeof User; title: string; description: string }) {
  return (
    <div className="flex items-start gap-3 border-b border-[#252929] px-5 py-4">
...
export default function SettingsPage() {
  ...
  const inputCls = "rounded-[8px] border border-[#252929] bg-[#131515] px-4 py-2.5 text-sm text-cream placeholder-muted/60 outline-none transition-colors focus:border-[#BCEDE2]/40";
    ...
    <div className="min-h-screen bg-[#090A0A] text-cream">
        ...
        <main className="flex-1 overflow-hidden p-5 sm:p-8">
          <div className="relative max-w-2xl">
            ...
            <div className="mb-8 border-b border-[#252929] pb-8">
              <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.14em] text-[#9A9E9B]">Account</p>
              ...
              <SectionCard>
                ...
                <div className="px-5 py-4 space-y-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2 rounded-[8px] border border-[#252929] bg-[#131515] px-4 py-2.5">
                      ...
                      {walletAddress && (
                        ...
                        >
                          {copiedWallet ? <Check className="h-3.5 w-3.5 text-[#BCEDE2]" /> : <Copy className="h-3.5 w-3.5" />}
                        </button>
                      )}
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 rounded-[8px] border border-[#252929] bg-[#131515] px-4 py-2.5">
                        ...
                        <button
                          ...
                          className="shrink-0 text-muted transition-colors hover:text-cream"
                        >
                          {copiedEmail ? <Check className="h-3.5 w-3.5 text-[#BCEDE2]" /> : <Copy className="h-3.5 w-3.5" />}
                        </button>
                      </div>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="rounded-[8px] bg-[#BCEDE2] px-5 py-2.5 text-xs font-medium uppercase tracking-[0.1em] text-[#090A0A] transition-opacity disabled:opacity-40 hover:bg-white"
                      >
              ...
              <SectionCard>
                ...
                <div className="px-5 py-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 rounded-[6px] border border-amber-400/30 bg-amber-400/10 px-3 py-1">
                  ...
                  <div className="mt-3 flex items-center justify-between rounded-[8px] border border-[#252929] bg-[#131515] px-4 py-3 opacity-60">
                    <div>
                    ...
                    <button
                      type="button"
                      disabled
                      className="rounded-[6px] border border-[#252929] px-3 py-1 text-[10px] font-medium uppercase tracking-[0.1em] text-muted cursor-not-allowed"
                    >
                      Locked
                    </button>
                  </div>
              ...
              <SectionCard>
                ...
                <div className="px-5 py-1">
                  {(
                    ...
                    <div
                      key={item.key}
                      className={`flex items-center justify-between py-3.5 ${idx < arr.length - 1 ? "border-b border-[#252929]" : ""}`}
                    >
                      <div>
                ...
                <div className="px-5 py-4 space-y-3">
                  <div className="rounded-[8px] border border-[#252929] bg-[#131515] p-4">
                    <div className="flex items-start gap-3">
                      <Key className="h-4 w-4 shrink-0 text-[#BCEDE2] mt-0.5" />
                  ...
                  {hasEmbeddedWallet ? (
                    <div>
                      <button
                        ...
                        className="flex w-full items-center justify-between rounded-[8px] border border-[#252929] bg-[#131515] px-4 py-3 text-sm font-medium text-cream transition-colors hover:border-[#313737]"
                      >
                    ...
                    <div className="flex items-start gap-3 rounded-[8px] border border-[#252929] bg-[#131515] px-4 py-3">
                ...
                <div className="px-5 py-4">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      onClick={logout}
                      className="flex items-center gap-2 rounded-[8px] border border-danger/30 bg-danger/10 px-4 py-2 text-xs font-medium uppercase tracking-[0.1em] text-danger transition-colors hover:bg-danger/20"
                    >
      ...
      {showExportModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md">
          <div className="relative mx-4 w-full max-w-md rounded-[12px] border border-[#252929] bg-[#0E1010] p-6 shadow-2xl">
            <button
              type="button"
            ...
            {exportStep === "warning" ? (
              <>
                <div className="flex h-10 w-10 items-center justify-center rounded-[8px] border border-danger/20 bg-danger/10 mb-4">
                ...
                <div className="mt-4 rounded-[8px] border border-danger/20 bg-danger/5 p-4">
                ...
                <div className="mt-5 flex gap-3">
                  <button
                    type="button"
                    onClick={() => setShowExportModal(false)}
                    className="flex-1 rounded-[8px] border border-[#252929] py-2.5 text-xs font-medium uppercase tracking-[0.1em] text-muted transition-colors hover:text-cream"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-1 rounded-[8px] border border-danger/30 bg-danger/10 py-2.5 text-xs font-medium uppercase tracking-[0.1em] text-danger transition-colors hover:bg-danger/20"
                  >
              ...
              <>
                <div className="flex h-10 w-10 items-center justify-center rounded-[8px] border border-[#BCEDE2]/20 bg-[#BCEDE2]/10 mb-4">
                  <CheckCircle className="h-5 w-5 text-[#BCEDE2]" />
                </div>
                ...
                <button
                  type="button"
                  onClick={() => setShowExportModal(false)}
                  className="mt-5 w-full rounded-[8px] border border-[#252929] py-2.5 text-xs font-medium uppercase tracking-[0.1em] text-muted transition-colors hover:text-cream"
                >
                  Done
                </button>
              </>
