    ...
    <div className="min-h-screen bg-[#090A0A] text-cream">
          ...
          <div className="relative">
            ...
            <div className="mb-6 grid gap-3 lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <div className="rounded-[12px] border border-[#252929] bg-[#0E1010] p-5">
                <div className="flex items-start gap-3">
                  <Zap className="mt-0.5 h-4 w-4 shrink-0 text-[#BCEDE2]" />
                  <div>
            ...
            {payments.length === 0 ? (
              <div className="rounded-[12px] border border-[#252929] bg-[#0E1010] p-16 text-center">
                <RefreshCw className="mx-auto mb-4 h-8 w-8 text-[#9A9E9B]" />
              ...
              <div className="grid gap-3">
                {payments.map((payment) => (
                  <div key={payment.id} className="rounded-[12px] border border-[#252929] bg-[#0E1010] p-5 transition-colors hover:border-[#313737]">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-center gap-3">
                        <RefreshCw className="h-4 w-4 text-[#BCEDE2]" />
                        <div>
                    ...
                    <div className="mt-4 flex gap-2">
                      ...
                      <button type="button" onClick={() => removePayment(payment.id)} className="rounded-[8px] border border-red-400/30 px-4 py-1.5 text-[11px] font-medium uppercase tracking-[0.1em] text-red-400 transition-colors hover:bg-red-400/10">
                        Remove
                      </button>
                    </div>
                  </div>
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md p-4">
          <div className="w-full max-w-lg rounded-[12px] border border-[#252929] bg-[#0E1010] p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-2 rounded-[8px] border border-[#BCEDE2]/20 bg-[#BCEDE2]/5 p-3 text-[10px] leading-5 text-[#BCEDE2]">
